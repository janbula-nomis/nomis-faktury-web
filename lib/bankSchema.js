 ...
 *   "Daňová platba" (od v4.6, viz claude/nomis-faktury-backlog.md, položka
 *                    9) - odchozí platba ručně přiřazená k dani (Typ_dane
 *                    vyplněné, viz níž) přes akci "Přiřadit k dani" v
 *                    detailu pohybu - appka NEROZPOZNÁVÁ tohle přiřazení
 *                    automaticky podle protistrany/textu (na rozdíl od
 *                    ostatních návrhů shody výš) - jen sčítá už ručně
 *                    přiřazené platby do Daňového přehledu, appka NIKDY
 *                    daň nedopočítává, jen eviduje skutečně zaplacené
 *                    částky
 *
 * Typ_dane (od v4.6) - u pohybů se Stav_parovani = "Daňová platba" appka
 * rozlišuje "Dan_z_prijmu" (daň z příjmu) a "Dan_z_nemovitosti" (daň z
 * nemovitostí) - silniční daň appka zatím nepodporuje (viz backlog,
 * odloženo na později). Appka tyhle typy jen SČÍTÁ podle firmy/měsíce do
 * Daňového přehledu, nedopočítává je (na rozdíl od DPH bilance, kterou
 * appka počítá z Dokladů/Vydaných faktur - viz netlify/functions/danovy-
 * prehled.js).
 *
