...
async function extrahujDataZDokladu(buffer, mimeType, firmy) {
  ...
  const prompt =
    ...
    '  "cislo_uctu_dodavatele": string nebo "" (bankovní účet DODAVATELE uvedený na ' +
      'dokladu pro úhradu - číslo účtu v tvaru jak je na dokladu napsané, např. ' +
      '"123456789/0800" nebo IBAN "CZ...", NE účet appčiny vlastní firmy),\n' +
    ...
    '  "polozky": pole objektů - JEDNOTLIVÉ ŘÁDKY dokladu, pokud jsou na ' +
      ...
      'ne celková cena řádku, pokud doklad uvádí jen celkovou cenu řádku a ' +
      'množství je 1, jde o totéž číslo), "sazba_dph" (string, sazba DPH téhle ' +
...
async function extrahujDataZVydaneFaktury(buffer, mimeType, firmy) {
  ...
  const prompt =
    ...
    '  "polozky": pole objektů - JEDNOTLIVÉ ŘÁDKY faktury, pokud jsou na ní ' +
      ...
      'cena JEDNOHO kusu BEZ DPH), "sazba_dph" (string, sazba DPH téhle ' +
