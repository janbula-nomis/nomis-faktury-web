 ...
 *   nepřerovná.
 *
 * Od v4.19 (Jan: "příjmy z nájmu přiřadit k bankovním vypisům, zdrojem
 * jsou nájemní smlouvy, které načtu do registru smluv"):
 * - `Nemovitost_ID` – volitelné propojení na novou entitu Nemovitosti (viz
 *   lib/nemovitostiSchema.js) - appka ho u smluv typu "Nájem" používá k
 *   zařazení do přehledu nájmů v nové záložce Nemovitosti. U ostatních typů
 *   smlouvy (Energie/Leasing/Ostatní) appka pole nechává prázdné.
 */
