...
function navrhniShoduPrijem(pohyb, kandidatiFaktury) {
  ...
  kandidatiFaktury.forEach((f) => {
    ...
    const plnaShoda = Math.abs(castkaFaktury - castkaPohybu) <= 1; // tolerance 1 Kč na zaokrouhlení
    const castecnaShoda = !plnaShoda && castkaPohybu > 0 && castkaPohybu < castkaFaktury - 1;
