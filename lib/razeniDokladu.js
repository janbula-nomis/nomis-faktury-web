...
// (v4.75) Pravidlo „co je mimo firemní účet" sedí na jednom místě, ať se
// řazení, odznak v seznamu a názvy scanů nemůžou rozejít - viz komentář
// u jeHrazenoMimoUcet.
const { jeHrazenoMimoUcet } = require('./nazvyScanu');
 ...
 * v seznamu (viz lib/nazvyScanu.js -> jeHrazenoMimoUcet): platba mimo
 * firemní účet se nepáruje a počítá se jako vyřízená. Od v4.75 sem patří
 * i způsob platby „Hotovost" - hotovost je mimo účet z definice.
 */
