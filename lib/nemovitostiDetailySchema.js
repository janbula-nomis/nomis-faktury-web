 ...
 *
 * `Najemni_jednotka_ID` (od v4.86) - stejné pravidlo jako u klíčů a měřidel:
 * **prázdno znamená „společné pro celý byt", ne „nevyplněno"**. Kód od
 * závory u domu zná každý nájemník, kód od vlastní schránky jen jeden.
 * Do v4.85 tohle pole kódy jako jediné z pěti seznamů neměly, takže se do
 * protokolu pro jednotku 1a tiskly i kódy patřící 1b - stejná chyba, jakou
 * měly klíče a WiFi před v4.82.
 */
const PRISTUPOVE_KODY_HEADERS = [
  'ID', 'Stredisko', 'Najemni_jednotka_ID', 'Nazev', 'Umisteni', 'Kod',
